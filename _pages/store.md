...
<div class="row">
    <div class="col">
        ...
        <div class="alert alert-info" role="alert">
          💡 <strong>어필리에이트 안내</strong> 클립 스튜디오 페인트, 알리 익스프레스, 토스 쇼핑, Yes24의 링크를 통해 구매가 이루어지는 경우 일정액의 수수료를 제공받을 예정입니다. 과연 인출 가능 금액을 넘어설 수 있을까 반신반의합니다만 그럼에도 불구하고 행여나 인출할 수 있게 되면 다음 책을 준비하는 데 활용하겠습니다. 늘 도움 주시고 응원해 주셔서 감사합니다! :)
        </div>
